...
class Cbt_tesgrup_model extends CI_Model{
	...
	function get_datatable($start, $rows, $grup_id){
		...
		$this->db->select('cbt_tesgrup.*, cbt_tes.tes_id, cbt_tes.tes_nama, cbt_tes.tes_begin_time, cbt_tes.tes_end_time, cbt_tes.tes_duration_time, cbt_tes.tes_max_score, cbt_tes.tes_detail_to_users')
