...
<html>
  <head>
	...
	<meta name="description" content="Aplikasi Ujian Online SMAN 20 BATAM CBT">
	<meta name="keywords" content="Aplikasi Ujian Online SMAN 20 BATAM CBT">
    ...
    <link href="<?php echo base_url(); ?>public/css/color-overrides.css" rel="stylesheet" type="text/css" />
  ...
  <!-- Tambahkan Tailwind CSS CDN di bagian <head> -->
  <?php /* Tambahkan hanya jika belum ada Tailwind di template ini */ ?>
  ...
  <body class="skin-red layout-top-nav">
    <div class="wrapper">
      ...
      <footer class="main-footer no-print bg-gray-900 text-white py-4 mt-8">
        <div class="container mx-auto flex flex-col md:flex-row items-center justify-between">
          <span class="text-sm md:text-base font-semibold tracking-wide">&copy; Assessment CBT Sarana_online</span>
          <span class="text-xs md:text-sm mt-2 md:mt-0">Powered by SARANA AKSES PRATAMA .PT <a href="" class="text-blue-400 hover:underline"></a></span>
        </div>
      </footer>
    </div><!-- ./wrapper -->
