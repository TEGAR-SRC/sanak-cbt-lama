...
/* ---------------------------------------------------------------
 ...
 | so database.php (and other configs) can read credentials.
 | Lines beginning with # are comments. Values are trimmed; quotes optional.
 | Only runs once and is safe if .env is missing.
 * ------------------------------------------------------------- */
if ( ! function_exists('zyacbt_load_env')) {
      function zyacbt_load_env() {
            static $loaded = FALSE;
            if ($loaded) return; // idempotent
            $root = realpath(__DIR__ . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . '..');
            $envFile = $root . DIRECTORY_SEPARATOR . '.env';
            if (!is_readable($envFile)) { $loaded = TRUE; return; }
